...
function flipCard() {
    scoreCount++;
    document.getElementById("score__now").innerHTML = "Imkon:" + Math.floor(scoreCount/2);
    document.getElementById("score__result").innerHTML = "Imkonlaringiz:" + " " + Math.floor(scoreCount/2) + " urinish";
    if (scoreCount/2 <= 6) {
        document.getElementById("prize").innerHTML = "Urinishlar soni 20%";
        document.getElementById("benefit").innerHTML = randomOne() + "20" + randomString + codeDate;
    } else if (scoreCount/2 > 6 && scoreCount/2 <= 10) {
        document.getElementById("prize").innerHTML = "Urinishlar soni 15%";
        document.getElementById("benefit").innerHTML = randomOne() + "15" + randomString + codeDate;
    } else {
        document.getElementById("prize").innerHTML = "Urinishlar soni 10%";
